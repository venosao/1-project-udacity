...
def get_input_args():
    ...
    parser.add_argument('--arch', type=str, default = 'vgg', help='classification help' )
    parser.add_argument('--dogfile', type=str, default = 'dognames.txt', help='path to text file' )
